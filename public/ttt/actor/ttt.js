...
/*
  ...
  document.write("<script src='"+global.ttt_top+"/vendor/dramatis/lib/dramatis/future.js' type='text/javascript'></script>");
  ...
  document.write("<script src='"+global.ttt_top+"/vendor/dramatis/vendor/strophejs/src/core.js' type='text/javascript'></script>");
  ...
  document.write("<script src='"+global.ttt_top+"/lib/ttt/game/view/table/actor.js' type='text/javascript'></script>");
  document.write("<script src='"+global.ttt_top+"/lib/ttt/game/view/svg/actor.js' type='text/javascript'></script>");
  document.write("<script src='"+global.ttt_top+"/lib/ttt/server/view/actor.js' type='text/javascript'></script>");
